...
class Email:
    ...
    def send_email(measure):
        ...
        params = {'first_name': measure.patient.first_name, 'last_name': measure.patient.last_name, 'ci':measure.patient.cedula, 'url': "https://glucotest.herokuapp.com/medidas/"+measure.patient.cedula, 'measure': measure.value, 'creation_date': measure.creation_date}
