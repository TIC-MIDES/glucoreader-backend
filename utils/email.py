...
class Email:
    ...
    def send_email(measure):
        ...
        params = {'first_name': measure.patient.first_name, 'last_name': measure.patient.last_name, 'photo': measure.photo, 'measure': measure.value, 'creation_date': measure.creation_date}
